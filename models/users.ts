...
export class users extends Model<usersAttributes, usersCreationAttributes> implements usersAttributes {
  ...
  addListId_lists!: Sequelize.BelongsToManyAddAssociationsMixin<lists, listsId>;
  createListId_list!: Sequelize.BelongsToManyCreateAssociationMixin<lists>;
  removeListId_list!: Sequelize.BelongsToManyRemoveAssociationMixin<lists, listsId>;
  removeListId_lists!: Sequelize.BelongsToManyRemoveAssociationsMixin<lists, listsId>;
